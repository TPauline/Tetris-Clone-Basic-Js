...
function visualizerRotations(tetri,x,y){
    // console.log("current tetrimino", tetri)
    ...
    tetri[ran % Object.keys(tetri).length].forEach(pair => {
        r = pair[0]
        c = pair[1]
...
setInterval(() =>{
    visualizerRotations(l_block,0,0);
}, 500);

setInterval(() =>{
    visualizerRotations(j_block,0,7);
}, 500);

setInterval(() =>{
    visualizerRotations(i_block,6,0);
}, 500);

setInterval(() =>{
    visualizerRotations(t_block,6,7);
}, 500);


setInterval(() =>{
    visualizerRotations(s_block,14,0);
}, 500);

setInterval(() =>{
    visualizerRotations(z_block,14,7);
}, 500);

setInterval(() =>{
    visualizerRotations(o_block,18,4);
}, 500);
